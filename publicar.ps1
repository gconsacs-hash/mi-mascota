# ============================================================
#  Publicar "Mi Mascota" en GitHub Pages
...
$Archivos = @(
  "index.html", "style.css", "datos.js", "personajes.js", "juegos.js", "app.js",
  "sw.js", "manifest.json",
  "assets/icono-192.png", "assets/icono-512.png", "assets/logo-cffamilia.svg"
)

Write-Host ""
Write-Host "🐣 Publicando Mi Mascota..." -ForegroundColor Cyan
...
if (-not $existe) {
  ...
  gh repo create $Repo --public --description "Mi Mascota - juego de cuidar mascotas para los hijos (CFfamilia)" | Out-Null
...
Write-Host ""
Write-Host "✅ ¡Listo! En 1 o 2 minutos el juego estará en:" -ForegroundColor Green
Write-Host "   $url" -ForegroundColor Green
Write-Host ""
Write-Host "   Ábrelo en el teléfono con Chrome y toca 'Instalar' para tenerlo como app."
Write-Host ""
